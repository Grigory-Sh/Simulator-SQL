/*
Для каждой рекламной кампании посчитайте среднюю стоимость заказа привлечённых пользователей
...
FROM (SELECT ads_campaign, user_id, ROUND(AVG(caost_order), 2) AS avg_check
      FROM (SELECT CASE WHEN user_id IN (8631, 8632, 8638, 8643, 8657, 8673, 8706, 8707, 8715, 8723, 8732, 8739, 8741,
            ...
            WHERE order_id NOT IN (SELECT order_id FROM user_actions WHERE action = 'cancel_order')
                  AND DATE_PART('month', time) = 9 AND DATE_PART('day', time) BETWEEN 1 and 7) AS t1
      LEFT JOIN
           (SELECT order_id, SUM(price) AS caost_order
